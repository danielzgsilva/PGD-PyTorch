...
# Visualizes a batch of ImageNet images and perturbations generated by PGD
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        # predictions on adversaries
        adv_outputs = model(adv_images)
        adv_predictions = torch.argmax(adv_outputs.data, 1)

    bs = images.size(0)
    # Save/display adversarial examples and predictions
    for i in range(bs):
        orig_image = images[i]
